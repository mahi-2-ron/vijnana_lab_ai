  ...
  return (
    <div className="pt-24 px-6 md:px-12 lg:px-20 min-h-screen pb-12">
      ...
      <div className="mb-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
            <h1 className="text-3xl md:text-4xl font-display font-bold text-white mb-2 flex items-center gap-4">
               <div>{greetings[lang]}, <span className="text-blue-400">{userName}</span>! 👋</div>
               <span className="px-3 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800 align-middle">Student</span>
            </h1>
